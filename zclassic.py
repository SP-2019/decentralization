...
miners=[]
stats=[]
f_w=open("classic.txt",'w')

for j in range(10000):

	page='http://explorer.zclmine.pro/insight-api-zcash/block-index/'+str(401840-j)
	...
	page='http://explorer.zclmine.pro/insight-api-zcash/block/'+bxhash
	page=requests.get(page)
	html = page.text
	...
	page='http://explorer.zclmine.pro/insight-api-zcash/tx/'+txhash
	page=requests.get(page)
	html = page.text
