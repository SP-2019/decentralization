...
for j in range(10000):
	...
	page='https://chainz.cryptoid.info/pura/block.dws?'+str(137973-j)+'.htm'
	...
	if i==-1:
		page='https://chainz.cryptoid.info/pura/api.dws?q=getblockhash&height='+str(137973-j)
		page=requests.get(page)
		html = page.text
		while html.find('wait 5')!=-1:
			sleep(360)
		...
		page='https://chainz.cryptoid.info/explorer/block.txs.dws?coin=pura&h='+bxhash+'.js'
		page=requests.get(page)
		html = page.text
