...
miners=[]
stats=[]
f_w=open("zcoin.txt",'w')

for j in range(10000):

	page='https://explorer.zcoin.io/insight-api-zcoin/block-index/'+str(109558-j)
	...
	page='https://explorer.zcoin.io/insight-api-zcoin/txs?block='+bxhash
	page=requests.get(page)
	html = page.text
	value=0
	while value<20:
		i=html.find('"value"')
		html=html[i+len('"value":"'):-1]
		i=html.find('"')
		value=float(html[:i])
