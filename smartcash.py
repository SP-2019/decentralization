...
miners=[]
stats=[]
f_w=open("smart.txt",'w')

for j in range(10000):
	page='https://explorer-webapi.azurewebsites.net/api/smartexplorer/GetBlockInfoWithTransactionsByHeight/'+str(701417-j)
