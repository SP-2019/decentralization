...
for j in range(100000):
	page='https://eos.greymass.com/v1/chain/get_block'
	data={"block_num_or_id": 21825314-j}
	page=requests.post(page, json=data) 
	html = page.text

	i=html.find('"producer":"')
	html=html[i+len('"producer":"'):]
	i=html.find('"')
	miner=html[0:i]
