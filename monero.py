...
miners=[]
stats=[]
f_w=open("monero.txt",'w')

for j in range(10000):
	page='https://minergate.com/ccapi/1.0/mro/blocks/'+str(1683033-j)+'/full'
	page=requests.get(page)
	html = page.text
	i=html.find('"transactions":')
	i1=html.find('","size"')
	txhash=html[i+25:i1]

	page='https://minergate.com/ccapi/1.0/mro/transactions/'+txhash+'/full'
	page=requests.get(page)
	html = page.text

	i = html.find('"txOutKey":')
	i1 =html.find('","globalIndex"')
	miner=html[i+12:i1]
