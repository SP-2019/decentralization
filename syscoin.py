...
miners=[]
stats=[]
f_w=open("syscoin.txt",'w')

for j in range(10000):
	i=-1
	while i==-1:
		page='https://chainz.cryptoid.info/sys/api.dws?q=getblockhash&height='+str(229413-j)
	...
	i=-1
	while i==-1:
		page='https://chainz.cryptoid.info/explorer/block.txs.dws?coin=sys&h='+bxhash+'.js'
		page=requests.get(page)
		html = page.text
		i = html.find('{"a":')
		if i==-1:
