...
for j in range(10000):
	...
	page='https://chainz.cryptoid.info/via/api.dws?q=getblockhash&height='+str(5545062-j)
	...
	while html.find('wait 5')!=-1:
		...
		html = page.text
	bxhash=html[1:-1]
	page='https://chainz.cryptoid.info/explorer/block.txs.dws?coin=via&h='+bxhash+'.js'
	page=requests.get(page)
	html = page.text
	while html.find('wait 5')!=-1:
		sleep(360)
