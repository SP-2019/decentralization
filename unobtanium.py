...
for j in range(10000):
	page='https://chainz.cryptoid.info/uno/search.dws?q='+str(1194468-j)
	page=requests.get(page) 
	html = page.text
	i=html.find('block.dws?')
	while i==-1:
		sleep(360)
		page='https://chainz.cryptoid.info/uno/search.dws?q='+str(1194468-j)
		page=requests.get(page) 
	...
	page='https://chainz.cryptoid.info/explorer/block.txs.dws?coin=uno&h='+bxhash
	page=requests.get(page)
	html = page.text
	i=html.find('"a":')
