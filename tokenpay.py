...
miners=[]
stats=[]
f_w=open("token.txt",'w')

for j in range(10000):
	page='https://explorer.tpay.ai/api/getblockhash?index='+str(368439-j)
	page=requests.get(page)
	html = page.text

	page='https://explorer.tpay.ai/api/getblock?hash='+html
	page=requests.get(page)
	html = page.text
	...
	page='https://explorer.tpay.ai/api/getrawtransaction?txid='+txhash+'&decrypt=1'
	page=requests.get(page)
	html = page.text
