...
miners=[]
stats=[]
f_w=open("burst.txt",'w')

for j in range(10000):
	page='https://explore.burst.cryptoguru.org/api/v1/block/'+str(545000-j)
	page=requests.get(page)
	html = page.text
	i = html.find('"reward_recipient_name":"')
	miner=html[i+len('"reward_recipient_name":"'):i+len('"reward_recipient_name":"')+9]
