...
miners=[]
stats=[]
f_w=open("private.txt",'w')

for j in range(10000):

	page='https://explorer.btcprivate.org/api/block-index/'+str(407983-j)
	...
	page='https://explorer.btcprivate.org/api/block/'+bxhash
	page=requests.get(page)
	html = page.text
	...
	page='https://explorer.btcprivate.org/api/tx/'+txhash
	page=requests.get(page)
	html = page.text
