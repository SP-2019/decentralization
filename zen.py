...
for j in range(10000):
	...
	page='https://explorer.zen-solutions.io/api/block-index/'+str(394922-j)
	...
	page='https://explorer.zen-solutions.io/api/block/'+bxhash
	page=requests.get(page)
	html = page.text
	...
	page='https://explorer.zen-solutions.io/api/tx/'+txhash
	page=requests.get(page)
	html = page.text
