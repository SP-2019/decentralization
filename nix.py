...
for j in range(10000):
	page='https://chainz.cryptoid.info/nix/api.dws?q=getblockhash&height='+str(75000-j)
	page=requests.get(page)
	html = page.text

	html=html[1:-1]
	page='https://chainz.cryptoid.info/explorer/block.txs.dws?coin=nix&h='+html+'.js'
	page=requests.get(page)
	html = page.text
