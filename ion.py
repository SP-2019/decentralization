...
for j in range(10000):
	k=0
	while k!=-1:
		page='https://chainz.cryptoid.info/ion/api.dws?q=getblockhash&height='+str(840000-j)
		page=requests.get(page)
		html = page.text
		k=html.find('5 minutes')
		if k!=-1:
			sleep(360)
	...
	k=0
	while k!=-1:
		page='https://chainz.cryptoid.info/explorer/block.txs.dws?coin=ion&h='+bxhash+'.js'
		page=requests.get(page)
		html = page.text
		k=html.find('5 minutes')
		if k!=-1:
