...
miners=[]
stats=[]
f_w=open("bitcore.txt",'w')

for j in range(10000):
	
	page='https://chainz.cryptoid.info/btx/api.dws?q=getblockhash&height='+str(239014-j)
	...
	while html.find('wait 5')!=-1:
		...
		html = page.text
	bxhash=html[1:-1]
	page='https://chainz.cryptoid.info/explorer/block.txs.dws?coin=btx&h='+bxhash+'.js'
	page=requests.get(page)
	html = page.text
	while html.find('wait 5')!=-1:
		sleep(360)
