...
for j in range(10000):
	page='https://chainz.cryptoid.info/pivx/block.dws?'+str(1409688-j)+'.htm'
	page=requests.get(page)
	html = page.text
	i = html.find('blockHash')
	i2 = html.find('hasMeta')
	blockhash=html[i+13:i2-8]

	page='https://chainz.cryptoid.info/explorer/block.txs.dws?coin=pivx&h='+blockhash
	page=requests.get(page)
	html = page.text
