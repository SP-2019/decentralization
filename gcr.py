...
for j in range(10000):
	page='https://chainz.cryptoid.info/gcr/api.dws?q=getblockhash&height='+str(1077000-j)
	page=requests.get(page)
	html = page.text

	html=html[1:-1]
	page='https://chainz.cryptoid.info/explorer/block.txs.dws?coin=gcr&h='+html+'.js'
	page=requests.get(page)
	html = page.text
